...
function minSubArrayLen(nums, sum){
    ...
    while(start < nums.length){
        ...
        // sum then move the window right
        ...
        // if the current window adds up to at least the sum
        // given we can shrink the window
        
    }
}
/*
Write a function called findLongestSubstring, which accepts a 
string and returns the length of the longest substring 
